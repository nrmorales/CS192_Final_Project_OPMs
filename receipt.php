...
<html>
    ...
    <body onLoad="MM_preloadImages('../CS192_presented/img/orderrollover.png','img/homerollover.png','img/servicesrollover.png','img/itemsrollover.png','img/aboutrollover.png','img/transactionsrollover.png','img/adminrollover.png','img/receiptrollover.png')">
...
<table width="1020" height="200" border="1" align="center" class="maintable">
    <tr>
		...
		<table width="168" height="666" border="0" class="sidetablestyle">
...
QUERY;
            $result = mysql_query($query) or die(mysql_error());            
			$prow = mysql_fetch_array($result);
			$_SESSION['client_name'] = $prow['name'];
            /*
              This is the query for transaction_service table in the database and it displays the table
...
OUTPUT;
				$data[$i] = array($name, $price, $quantity, $temp);
				$i++;
			}
    
	       	/*
          		This is the query for transaction_items table in the database and it displays the table
           		for the order receipt
           	*/
            $query = <<<QUERY
...
OUTPUT;
			...
			<form action="pdfreceipt.php" method="post">
